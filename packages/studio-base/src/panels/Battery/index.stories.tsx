...
import BatteryPanel from "./index";
...
export const InvalidValue: StoryObj = {
  render: function Story() {
    return <BatteryPanel overrideConfig={{ path: "/data.value", minValue: 0, maxValue: 1 }} />;
  },
...
export const CustomRange: StoryObj = {
  render: function Story() {
    return <BatteryPanel overrideConfig={{ path: "/data.value", minValue: 5, maxValue: 7 }} />;
  },
...
export const MessagePathWithFilter: StoryObj = {
  render: function Story() {
    return (
      <BatteryPanel overrideConfig={{ path: `/data{id=="b"}.value`, minValue: 0, maxValue: 4 }} />
    );
  },
